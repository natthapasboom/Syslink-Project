                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="department" type="text" class="form-control @error('username') is-invalid @enderror" name="department" value="{{ old('department') }}" required autocomplete="department" autofocus>
