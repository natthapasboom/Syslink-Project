<?php 
  ...
  $query = "
SELECT e.id as id, e.username as username, e.password as password, e.name as name, e.surname as surname, e.department as department,r.name as rname
...
<body class="hold-transition sidebar-mini">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../edit/employees" class="nav-link active">
  ...
  <script>
   ...
   "info": false,
    ...
    $('#employeesdelete').attr('action','../edit/employees/delete/'+data2[0]);        
    });
...
<div class="modal fade" id="editmodal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="../edit/employees/update" method="POST" id="employeesupdate">
        @csrf
        {{ method_field('PUT') }}
            ...
            <select name="editrole_id" class="form-control ">
              ...
              <?php
                ...
                $result = mysqli_query($connectrole,$query);
			          while($row = mysqli_fetch_array($result)){
                  ?>
              <option selected value="<?php echo $row["id"];?>"><?php echo $row["name"];?>
              </option>
              <?php
                  }
              ?>
...
<div class="modal fade" id="addmodal">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <form action="../edit/employees/create" method="POST">
        @csrf
        <div class="modal-body">
          <div class="form-group">
            <label>รหัสพนักงาน</label>
...
<div class="modal fade" id="deletemodal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="../edit/employees/delete" method="POST" id="employeesdelete">
        @csrf
        {{ method_field('delete') }}
        <div class="modal-body">
          <div class="form-group">
